...
export const metadata: Metadata = {
  ...
  description: "محامي معتمد ومترافع أمام المحكمة العليا في صنعاء. خدمات قانونية شاملة، استشارات للمغتربين في السعودية، قضايا الأسرة، الشركات، والعقود.",
  keywords: [
    "محامي في صنعاء",
    "أفضل محامي في صنعاء",
  ...
  openGraph: {
    ...
    description: "محامي معتمد أمام المحكمة العليا يقدم خدمات قانونية متكاملة داخل اليمن .",
...
export default function RootLayout({
  ...
  return (
    <html lang="ar" dir="rtl">
      <body className={`font-body ${playfairDisplay.variable} ${inter.variable} ${amiri.variable}`}>
