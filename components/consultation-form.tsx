    ...
    <Card className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-primary/30 hover:shadow-2xl transition-all duration-500">
      <CardContent className="p-8 space-y-6">
        <div className="text-center space-y-4">
          ...
          <h3 className="text-2xl font-bold bg-gradient-to-l from-primary to-foreground bg-clip-text text-transparent">
            نموذج طلب استشارة
          </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background/50 border-primary/20 focus:border-primary transition-all duration-300 hover:border-primary/40"
                required
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="bg-background/50 border-primary/20 focus:border-primary resize-none transition-all duration-300 hover:border-primary/40"
              required
            />
          </div>
          ...
          <Button
            ...
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl hover:shadow-primary/25 transition-all duration-300 hover:scale-[1.02] group disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
              <>
        ...
        <div className="pt-6 border-t border-primary/20">
          <div className="text-center space-y-3">
            <p className="text-sm font-medium text-muted-foreground">تخصصاتنا القانونية:</p>
